...
const PlaylistResult = forwardRef<HTMLDivElement, PlaylistResultProps>(
  (
    {
      selectedPlaylistVisibility,
      isOwner,
    ...
    const [isDeleteInProgress, setIsDeleteInProgress] =
            ...
            >
              <CardHeader className="relative p-0">
                <div className="group relative">
                  <Image
                    src={
                      playlist.videos[0]?.thumbnail.url || "/placeholder.svg"
                    }
                    alt={playlist.title}
              ...
              <CardFooter className="p-4 pt-0 flex justify-between text-sm text-muted-foreground">
                ...
                <div>
                  Updated {dayjs(new Date(playlist.updatedAt)).from(now)}
                </div>
              </CardFooter>
            </Card>
          ))}
...
const ChannelPlaylists = forwardRef<HTMLDivElement, ChannelPlaylistsProps>(
  (
    {
      selectedPlaylistVisibility,
